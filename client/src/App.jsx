        ...
        <UserProvider>
          <UnsavedChangesProvider>
            <Routes>
              ...
              />
              <Route
                path="/edit-seating-chart/:teacherId/:classroomId"
                element={<EditSeatingChart />}
              />
              <Route
                path="/viewclasslist/:teacherId/:classroomId"
                element={<ClassList />}
              />
              <Route
                path="/editneedsgoals/:teacherId/:classroomId"
                element={<NeedsGoals />}
              />
              <Route
                path="/:teacherId/:classroomId/:studentId"
                element={<StudentProfile />}
              />
              <Route path="/edit/:teacherId" element={<EditTeacher />} />
              <Route path="/createclass" element={<CreateClass />} />
              <Route path="/add-student" element={<AddStudentToClassroom />} />
              {/* Student Routes */}
