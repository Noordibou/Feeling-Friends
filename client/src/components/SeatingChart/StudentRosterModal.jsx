...
const AddStudentModal = ({
  ...
  return (
    <>
      ...
      <div className="bg-[#D2C2A4] border-[8px] border-[#A59F8B] fixed md:absolute mr-auto ml-auto z-10 md:mt-[175px] md:w-[752px] w-screen h-screen md:h-[61%] rounded-lg opacity-90"></div>
