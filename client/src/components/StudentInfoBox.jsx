          ...
          >
            {lastCheck ? (
              <div className="hidden xs:flex flex-col sm:w-60">
                <h5 className="font-[Poppins] text-[12px] md:text-[14px]"><b>Goals:</b> {lastCheck.goal}</h5>
                <h5 className="font-[Poppins] text-[12px] md:text-[14px]"><b>Needs:</b> {lastCheck.need}</h5>
              </div>
            ) : (
