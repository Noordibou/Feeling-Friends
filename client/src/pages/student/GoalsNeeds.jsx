...
const GoalsNeeds = () => {
  ...
  return (
    <>
      <main className="flex flex-col w-screen items-center bg-notebookPaper">
        <header className="flex w-full justify-center mt-10 sm:mt-20">
          <ProgressBar totalPages="5" currentPage="4" />
        </header>

        <section className="max-w-lg mt-8 sm:mt-16">
          ...
          <div className="w-full px-6 sm:px-0">
              ...
              <button
                className={`bg-${
                  selectedGoal === "Finish homework during study hall"
                    ? emotionColor
                    : "themeWhite"
                } m-2 p-4 w-1/2 text-[16px] sm:text-body font-body border-2 border-${emotionColor} rounded-[1rem] hover:bg-${emotionColor}`}
                onClick={() =>
            ...
            <div>
              {inputMode1 ? (
                <div className="p-2">
                  <label htmlFor="customGoal1" className="sr-only">
                    Type your goal here
                  </label>
                  <input
                    id="customGoal1"
                  ...
                  <button
                    ...
                    } mt-2 p-4 w-full text-[16px] sm:text-body font-body border-2 border-${emotionColor} hover:bg-${emotionColor}/60 rounded-[1rem]`}
                  >
                    Save
                  </button>
                </div>
                  ...
                  <button
                    className={`bg-${
                      selectedGoal === "Something else"
                        ? emotionColor
                        : "themeWhite"
                    } rounded-xl p-4 w-full text-[16px] sm:text-body font-body border-2 border-${emotionColor} hover:bg-${emotionColor}`}
                    onClick={() => {
        ...
        <section className="max-w-lg mt-5">
          <h2 className="text-[22px] sm:text-header2 font-header2 text-center mx-4">
          ...
          <div className="w-full px-6 sm:px-0">
              ...
              <button
                className={`bg-${
                  selectedNeed === "Help with focusing"
                    ? emotionColor
                    : "themeWhite"
                } m-2 p-4 w-1/2 text-[16px] sm:text-body font-body border-2 border-${emotionColor} hover-bg-${emotionColor} rounded-[1rem]`}
            ...
            {inputMode2 ? (
              <div className="p-2">
                <label htmlFor="customNeed" className="sr-only">
                  Enter your what you need from teacher here
                </label>
                <input
                  id="customNeed"
                  type="text"
