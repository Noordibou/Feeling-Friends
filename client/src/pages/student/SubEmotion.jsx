...
const SubEmotion = () => {
  ...
  return (
    <main className="flex flex-col items-center h-screen min-w-screen flex-grow">
      ...
      <div className="flex flex-col self-end w-full h-full  flex-grow justify-center">
        <section className="font-[Karla] text-[22px] font-semibold sm:font-header2 sm:text-header2 text-center pt-8 ">
          <h2>Choose the emotion closest to</h2>
          <span>what you're feeling.</span>
        </section>
        {/* sub emotion and other emotions */}
        <section className="flex flex-col flex-grow text-center sm:mt-10 h-full w-full items-center">
          {/* sub emotions only */}
          ...
          <div
            className="mt:-mt-10 sm:-mt-20 md:-mt-10 justify-center w-11/12 md:w-[750px]"
            aria-labelledby="other-emotions-heading"
          >
            <div className="flex justify-between">
              <button
                className="rounded-full w-16 h-16 sm:w-24 sm:h-2"
                onClick={() => changeEmotion(matchedEmotions[0].emotion)}
                aria-label={`Change to ${matchedEmotions[0].emotion}`}
              >
                <img
                  src={matchedEmotions[0].eImage}
                  alt={`${matchedEmotions[0].emotion} icon`}
              ...
              <button
                ...
                aria-label={`Change to ${matchedEmotions[1].emotion}`}
              >
                <img
                  src={matchedEmotions[1].eImage}
                  alt={`${matchedEmotions[1].emotion} icon`}
                  className="w-22 h-22 object-fill "
                />
              </button>
            </div>
            ...
            <div className="flex justify-around">
              <button
                ...
                aria-label={`Change to ${matchedEmotions[2].emotion}`}
              >
                <img
                  src={matchedEmotions[2].eImage}
                  alt={`${matchedEmotions[2].emotion} icon`}
                  className="w-22 h-22 object-fill "
                />
              </button>
              <button
                ...
                aria-label={`Change to ${matchedEmotions[3].emotion}`}
              >
                <img
                  src={matchedEmotions[3].eImage}
                  alt={`${matchedEmotions[3].emotion} icon`}
                  className="w-22 h-22 object-fill "
                />
              </button>
            </div>
            ...
            <div className="-mt-12 sm:mt-10 flex justify-center">
              <button
                ...
                aria-label={`Change to ${matchedEmotions[4].emotion}`}
              >
                <img
                  src={matchedEmotions[4].eImage}
                  alt={`${matchedEmotions[4].emotion} icon`}
                  className="w-22 h-22 object-fill"
                />
              </button>
            </div>
