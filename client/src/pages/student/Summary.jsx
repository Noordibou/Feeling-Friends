...
const Summary = () => {
  ...
  return (
    <>
      <main className="pt-[4rem] flex flex-col items-center min-h-screen">
        <div className="max-w-[1200px] ">
          <header className="flex w-full justify-center mb-10 sm:mb-20 ">
          ...
          <CopingSkillCard
            emotion={emotionFromParams.toLowerCase()}
