...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        "inner-md":
          "inset 0 8px 13px rgba(110, 110, 110, 0.6), inset 0 -8px 13px rgba(110, 110, 110, 0.6), inset 8px 0 13px rgba(110, 110, 110, 0.6), inset -8px 0 13px rgba(110, 110, 110, 0.6)",
